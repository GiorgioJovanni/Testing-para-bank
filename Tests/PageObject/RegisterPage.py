...
class RegisterPage(BasePage):
    ...
    def register_new_fake_user(self):
        self.add_text_in_border_first_name()
        self.add_text_in_border_last_name()
        self.add_text_in_border_address()
        self.add_text_in_border_city()
        self.add_text_in_border_state()
        self.add_text_in_border_zipcode()
        self.add_text_in_border_phone()
        self.add_text_in_border_snn()
        self.add_text_in_border_username()
        self.add_text_in_border_password()
        self.add_text_in_border_confirm()
        self.press_the_button_register()
        self.should_not_be_button_register()

    def register_new_fake_user_without_address(self):
        self.add_text_in_border_first_name()
        self.add_text_in_border_last_name()
        self.add_text_in_border_city()
        self.add_text_in_border_state()
        ...
        self.add_text_in_border_confirm()
        self.press_the_button_register()
        self.should_be_text_error()

    def register_new_fake_user_without_city(self):
        self.add_text_in_border_first_name()
        self.add_text_in_border_last_name()
        self.add_text_in_border_address()
        self.add_text_in_border_state()
    ...
    def register_new_fake_user_without_state(self):
        self.add_text_in_border_first_name()
        self.add_text_in_border_last_name()
        self.add_text_in_border_address()
        self.add_text_in_border_city()
    ...
    def register_new_fake_user_without_zipcode(self):
        self.add_text_in_border_first_name()
        self.add_text_in_border_last_name()
        self.add_text_in_border_address()
        self.add_text_in_border_city()
